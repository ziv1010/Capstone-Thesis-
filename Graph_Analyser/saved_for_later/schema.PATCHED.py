...
BASE_TEXT_NODE_TYPES = ("preamble", "facts", "arguments")
ARGUMENT_ROLE_NODE_TYPES = ("petitioner_arguments", "respondent_arguments", "other_lawyer_arguments")
TEXT_NODE_TYPES = BASE_TEXT_NODE_TYPES + ARGUMENT_ROLE_NODE_TYPES
ENTITY_NODE_TYPES = (
    "petitioner",
    "respondent",
    "court",
...
RELATION_DEFINITIONS: dict[tuple[str, str, str], bool] = {
    ...
    ("case", "has_petitioner_arguments", "petitioner_arguments"): True,
    ("case", "has_respondent_arguments", "respondent_arguments"): True,
    ("case", "has_other_lawyer_arguments", "other_lawyer_arguments"): True,
    ...
    ("preamble", "mentions_statute", "statute"): True,
    ("preamble", "mentions_provision", "provision"): True,
    ("preamble", "mentions_precedent", "precedent"): False,
    ("facts", "mentions_statute", "statute"): True,
    ("facts", "mentions_provision", "provision"): True,
    ("facts", "mentions_precedent", "precedent"): False,
    ...
    ("petitioner_lawyer", "citation", "petitioner_arguments"): True,
    ("defence_lawyer", "citation", "respondent_arguments"): True,
    ("lawyer", "citation", "other_lawyer_arguments"): True,
    ...
    ("petitioner", "is_party_in_arguments", "petitioner_arguments"): True,
    ("respondent", "is_party_in_arguments", "respondent_arguments"): True,
