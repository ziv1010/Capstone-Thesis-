...
#
# Usage:
#   bash run_inlegalbert_experiments.sh --status-only
#   nohup bash run_inlegalbert_experiments.sh > run_inlegalbert_experiments.log 2>&1 &
#   tail -f run_inlegalbert_experiments.log
#
# Notes:
