...
#   bash run_scripts/run_remaining_non_cross_bucket_ablations.sh --sync-only
#   bash run_scripts/run_remaining_non_cross_bucket_ablations.sh --buckets "fin_fraud_timed_mistral land_property_timed_mistral"
#   bash run_scripts/run_remaining_non_cross_bucket_ablations.sh --env thesis_work --k 5 --gpus-build 0,1,2,3,4,5,6,7
set -euo pipefail
