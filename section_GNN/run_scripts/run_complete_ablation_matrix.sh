...
#
# Usage:
#   nohup bash section_GNN/run_scripts/run_complete_ablation_matrix.sh \
#     > section_GNN/run_logs/run_complete_ablation_matrix.log 2>&1 &
#   tail -f section_GNN/run_logs/run_complete_ablation_matrix.log
# ─────────────────────────────────────────────────────────────────────────────
set -euo pipefail
