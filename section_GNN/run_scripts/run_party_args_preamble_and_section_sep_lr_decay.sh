...
#
# Usage:
#   bash run_scripts/run_party_args_preamble_and_section_sep_lr_decay.sh --status-only
#   bash run_scripts/run_party_args_preamble_and_section_sep_lr_decay.sh --sync-only
#   nohup bash run_scripts/run_party_args_preamble_and_section_sep_lr_decay.sh \
#     > run_logs/run_party_args_preamble_and_section_sep_lr_decay.log 2>&1 &
#
# Useful options:
