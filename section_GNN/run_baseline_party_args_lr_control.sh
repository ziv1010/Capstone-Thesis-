...
#
# Usage:
#   bash run_baseline_party_args_lr_control.sh --status-only
#   nohup bash run_baseline_party_args_lr_control.sh \
#     > run_baseline_party_args_lr_control.log 2>&1 &
#   tail -f run_baseline_party_args_lr_control.log
set -euo pipefail
