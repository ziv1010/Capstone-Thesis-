...
#
# Usage:
#   bash run_remaining_table_experiments_8gpu.sh --status-only
#   nohup bash run_remaining_table_experiments_8gpu.sh \
#     > run_remaining_table_experiments_8gpu.log 2>&1 &
#   tail -f run_remaining_table_experiments_8gpu.log
set -euo pipefail
...
PARTY_SYNC="$SECTION_GNN/run_party_args_preamble_and_section_sep_lr_decay.sh"
