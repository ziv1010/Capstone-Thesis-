...
PYTHON_SCRIPT="$PROJECT_ROOT/extra_scripts/add_multi_label_outcome_from_enriched.py"
...
declare -A OUTPUTS=(
    [family_matrimonial]="$PROJECT_ROOT/final_outputs/family_matrimonial_multi_labelled_mistral"
    [fin_fraud]="$PROJECT_ROOT/final_outputs/fin_fraud_multi_labelled_mistral"
    [land_property]="$PROJECT_ROOT/final_outputs/land_property_multi_labelled_mistral"
    [motor_accidents]="$PROJECT_ROOT/final_outputs/motor_accidents_multi_labelled_mistral"
    [sexual_offences]="$PROJECT_ROOT/final_outputs/sexual_offences_multi_labelled_mistral"
)
