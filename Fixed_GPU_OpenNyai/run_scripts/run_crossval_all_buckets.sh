...
SCRIPT="$PROJECT_ROOT/extra_scripts/add_case_outcome_labels_crossval_mistral.py"
MODEL="${MODEL:-mistralai/Mistral-Small-24B-Instruct-2501}"
BASE_INPUT="${BASE_INPUT:-$PROJECT_ROOT/final_outputs}"
BASE_OUTPUT="${BASE_OUTPUT:-$PROJECT_ROOT/cross_validated_outputs}"
