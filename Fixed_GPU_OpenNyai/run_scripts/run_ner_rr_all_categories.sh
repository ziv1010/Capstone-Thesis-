...
PYTHON_SCRIPT="$PROJECT_ROOT/run_ner_rr_custom.py"
...
declare -A INPUTS=(
    [family_matrimonial]="$REPO_ROOT/INPUT_DATA/family_matrimonial_text"
    [financial_fraud]="$REPO_ROOT/INPUT_DATA/financial_fraud_text"
    [land_property]="$REPO_ROOT/INPUT_DATA/land_property_text"
    [motor_accidents]="$REPO_ROOT/INPUT_DATA/motor_accidents_text"
    [sexual_offences]="$REPO_ROOT/INPUT_DATA/sexual_offences_text"
)

declare -A OUTPUTS=(
    [family_matrimonial]="$PROJECT_ROOT/final_outputs/family_matrimonial_extract"
    [financial_fraud]="$PROJECT_ROOT/final_outputs/fin_fraud_extract"
    [land_property]="$PROJECT_ROOT/final_outputs/land_property_extract"
    [motor_accidents]="$PROJECT_ROOT/final_outputs/motor_accidents_extract"
    [sexual_offences]="$PROJECT_ROOT/final_outputs/sexual_offences_extract"
)
