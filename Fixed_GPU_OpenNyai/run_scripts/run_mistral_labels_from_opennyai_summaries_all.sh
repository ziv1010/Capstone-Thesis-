...
PYTHON_SCRIPT="$PROJECT_ROOT/add_case_outcome_labels_from_enriched.py"
...
declare -A INPUTS=(
    [family_matrimonial]="$PROJECT_ROOT/final_outputs/family_matrimonial_summary_opennyai/enriched_jsons"
    [fin_fraud]="$PROJECT_ROOT/final_outputs/fin_fraud_summary_opennyai/enriched_jsons"
    [land_property]="$PROJECT_ROOT/final_outputs/land_property_summary_opennyai/enriched_jsons"
    [motor_accidents]="$PROJECT_ROOT/final_outputs/motor_accidents_summary_opennyai/enriched_jsons"
    [sexual_offences]="$PROJECT_ROOT/final_outputs/sexual_offences_summary_opennyai/enriched_jsons"
)

declare -A OUTPUTS=(
    [family_matrimonial]="$PROJECT_ROOT/final_outputs/family_matrimonial_labelled_mistral"
    [fin_fraud]="$PROJECT_ROOT/final_outputs/fin_fraud_labelled_mistral"
    [land_property]="$PROJECT_ROOT/final_outputs/land_property_labelled_mistral"
    [motor_accidents]="$PROJECT_ROOT/final_outputs/motor_accidents_labelled_mistral"
    [sexual_offences]="$PROJECT_ROOT/final_outputs/sexual_offences_labelled_mistral"
)
...
echo "============================================================"
echo "  Mistral Labels From OpenNyAI Summaries  —  All Categories"
...
echo "All Mistral labelling categories complete."
