...
def ensure_ner_model_available(model_name: str, logger: logging.Logger) -> None:
    ...
    try:
        ...
        raise RuntimeError(f"Model package {model_name} is still unavailable after installation attempts.") from exc
...
def _run_worker_process(
    ...
    validate_gpu_request(worker_config.use_gpu, logger)
