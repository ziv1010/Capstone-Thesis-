...
declare -A OUTPUTS=(
    [family_matrimonial]="$SCRIPT_DIR/final_outputs/family_matrimonial_labelled_mistral"
    [fin_fraud]="$SCRIPT_DIR/final_outputs/fin_fraud_labelled_mistral"
    [land_property]="$SCRIPT_DIR/final_outputs/land_property_labelled_mistral"
    [motor_accidents]="$SCRIPT_DIR/final_outputs/motor_accidents_labelled_mistral"
    [sexual_offences]="$SCRIPT_DIR/final_outputs/sexual_offences_labelled_mistral"
)
