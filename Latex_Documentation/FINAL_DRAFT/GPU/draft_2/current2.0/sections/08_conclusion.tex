...
PGExplainer and LLM verbalisation,
...
failures: when the prediction is confidently wrong, the selected
evidence can still form a legally plausible but incomplete explanation
for the \emph{wrong} label. A zero-shot evaluation on $11{,}769$
food-safety judgments, a
