...
Default behaviour starts the NER/RR inspector, final explanation browser, and
multi-hearing/early-detection app. Supplementary exploration pages are
...
# Temporarily hide and skip the supplementary graph/entity exploration pages.
SUPPLEMENTARY_EXPLORATION_ENABLED = False
...
def start_apps(args: argparse.Namespace, sites: list[Site]) -> None:
    ...
    if args.no_extras or not SUPPLEMENTARY_EXPLORATION_ENABLED:
        return
