...
MODEL_SUBFOLDER="${MODEL_SUBFOLDER:-INLegalLlama/SFT/Prediction_Only/pred_only_sft_llama2}"
ADAPTER_MODE="${ADAPTER_MODE:-peft}"
PROMPT_PROFILE="${PROMPT_PROFILE:-inlegalllama_case_proceeding}"
INPUT_DIR="${INPUT_DIR:-$SCRIPT_DIR/data/motor_accidents_fold_00_test_cases}"
OUTPUT_DIR="${OUTPUT_DIR:-$SCRIPT_DIR/outputs/lnlproc_inlegalllama_sft_pred_only_original_prompt_motor_accidents_fold00}"
NUM_GPUS="${NUM_GPUS:-8}"
GPU_IDS="${GPU_IDS:-}"
