...
OUTPUT_DIR="${OUTPUT_DIR:-$SCRIPT_DIR/outputs/factlegalllama_${CHECKPOINT}_motor_accidents_fold00}"
NUM_GPUS="${NUM_GPUS:-8}"
...
ADAPTER_DIR="$(
  micromamba run -n "$ENV_NAME" python "$SCRIPT_DIR/run_factlegalllama.py" \
