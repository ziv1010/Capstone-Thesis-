...
\section{Why LJP is Hard (the 6 challenges -- but written as a narrative, not just a list)}
...
\section{Why Graph-Based Approaches? (motivate your core thesis before describing it)}
